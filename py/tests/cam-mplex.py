...
#platform = "VIP-OV10635"
#platform = "FPD4"
#platform = "TI-FPD3"
#platform = "TI-FPD4"
#platform = "FPD3"
platform = "DRA76-OV5640"
#platform = "DRA76-OV5640-LEGACY"

if platform == "VIP-OV10635":
    configurations = importlib.import_module("cam-mplex-vip-ov10635").configurations
    config = configurations["vip-ov10635"]
elif platform == "DRA76-OV5640":
    configurations = importlib.import_module("cam-mplex-configs-ov5640").configurations
    config = configurations["dra7-ov5640"]
elif platform == "DRA76-OV5640-LEGACY":
    configurations = importlib.import_module("cam-mplex-configs-ov5640").configurations
    config = configurations["legacy-ov5640"]
elif platform == "TI-FPD3":
    configurations = importlib.import_module("cam-mplex-configs").configurations

    config = merge_configs(
                           "dra76-ub960-imx390.0-pixel",
                           "dra76-ub960-imx390.1-pixel",
                           )
elif platform == "TI-FPD4":
    configurations = importlib.import_module("cam-mplex-configs").configurations
    ...
    config = merge_configs(
                           "dra76-ub960-imx390.0-pixel",
                           "dra76-ub960-imx390.1-pixel",
                           "dra76-ub960-ov10635.2-pixel",
                           "dra76-ub960-imx390.0-meta",
                           "dra76-ub960-imx390.1-meta",
                           "dra76-ub960-ov10635.2-meta",
                           )

#config = configurations["dra7-ov5640"]
#config = configurations["legacy-ov5640"]
#config = configurations["am5-vip"]
